...
if response.status_code == 200:
    ...
    wb = load_workbook("final_leaderboard.xlsx")
    ws = wb.active
    ...
    # Save the changes
    wb.save("final_leaderboard_auto_fitted.xlsx")

    print("Data has been successfully saved to final_leaderboard_auto_fitted.xlsx")
else:
